    ...
    <div class="main-wrapper">
            ...
            <div class="sidebar-logo">
                <div>
                    ...
                    <a href="{{route('admin.dashboard')}}" class="logo logo-normal">
                        <img  src="/guest_assets/assets/images/logo.png" width="30px" height="30px" alt="Logo">
                    </a>
                ...
                <div class="sidebar-footer border-top mt-3">
                    <div class="trial-item mt-0 p-3 text-center">
                        <div class="trial-item-icon rounded-4 mb-3 p-2 text-center shadow-sm d-inline-flex">
                            <img  src="/guest_assets/assets/images/logo.png" width="100px" height="50px" alt="Logo">
                        </div>
                        <div>
                            <h6 class="fs-14 fw-semibold mb-1">Tushi Blog</h6>
                            <p class="fs-13 mb-0">Admin Dashboard</p>
                        </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="footer text-center bg-white p-2 border-top">
                <p class="text-dark mb-0">2025 &copy; <a href="javascript:void(0);" class="link-primary">Tushiblog</a>, All Rights Reserved</p>
            </div>
            <!-- Footer End -->
